...
async function initDb() {
  ...
  if (hasStaff.total === 0) {
    await run(
      `INSERT INTO staff (name, type, branch_id, base_salary, status, start_date)
       VALUES
       ('Nguyễn Văn An', 'main', 1, 5000000, 'active', '2024-01-01'),
       ('Trần Thị Bình', 'main', 1, 5500000, 'active', '2024-02-01'),
       ('Lê Hoàng Cường', 'assistant', 1, 4000000, 'active', '2024-03-01'),
       ('Phạm Thị Dung', 'assistant', 2, 4200000, 'active', '2024-01-15'),
       ('Hoàng Văn Em', 'main', 2, 5000000, 'active', '2024-04-01')`
    );
  }
